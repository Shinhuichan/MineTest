...
public class Liquid : MonoBehaviour
{
    ...
    void UpdatePos(float deltaTime)
    {
        ...
        if (CompensateShapeAmount > 0)
        {
            ...
            pos = worldPos - transform.position - new Vector3(0, (1f - fillAmount) - (comp.y * CompensateShapeAmount), 0);
        }
        else
        {
            pos = worldPos - transform.position - new Vector3(0, (1f - fillAmount), 0);
        }
